...
import { Container, SelectedModeContainer, Navbar, Title, SelectedDirectionContainer} from "./styles"
...
const EditorContainer: React.FC = () => {
	...
	return (
		<Container>
			...
			<Navbar>
				{mode === "" && (
					<Button onClick={() => setMode("node")} variant="primary">
						Node
					</Button>
				)}
				{mode === "" && (
					<Button onClick={() => setMode("edge")} variant="primary">
						Edge
					</Button>
				)}
				{mode === "" && (
					<Button onClick={() => setMode("algorithms")} variant="primary">
						Algorithms
					</Button>
				)}
				{mode === "" && (
					<Button onClick={() => setMode("moreinfos")} variant="primary">
						More Infos
					</Button>
				)}
